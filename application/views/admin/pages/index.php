        ...
        <div class="page-wrapper">
            ...
            <div class="container-fluid">
                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <div class="steamline m-t-40">
                                    ...
                                    <div class="sl-item">
                                        <div class="sl-left"> <img class="img-circle" alt="user" src="<?php echo admin_images_url();?>users/1.jpg"> </div>
                                        <div class="sl-right">
                                    ...
                                    <div class="sl-item">
                                        <div class="sl-left"> <img class="img-circle" alt="user" src="<?php echo admin_images_url();?>users/2.jpg"> </div>
                                        <div class="sl-right">
                                    ...
                                    <div class="sl-item">
                                        <div class="sl-left"> <img class="img-circle" alt="user" src="<?php echo admin_images_url();?>users/3.jpg"> </div>
                                        <div class="sl-right">
                ...
                <div class="row">
                    <div class="col-lg-6">
                        <!-- column -->
                        <div class="card news-slide" style="background:url(<?php echo admin_images_url();?>background/img5.jpg) center center / cover;">
                                ...
                                <div class="to-do-widget m-t-20">
                                    ...
                                    <ul class="list-task todo-list list-group m-b-0" data-role="tasklist">
                                        <li class="list-group-item" data-role="task">
                                            ...
                                            <ul class="assignedto">
                                                <li><img src="<?php echo admin_images_url();?>users/1.jpg" alt="user" data-toggle="tooltip" data-placement="top" title="" data-original-title="Steave"></li>
                                                <li><img src="<?php echo admin_images_url();?>users/2.jpg" alt="user" data-toggle="tooltip" data-placement="top" title="" data-original-title="Jessica"></li>
                                                <li><img src="<?php echo admin_images_url();?>users/3.jpg" alt="user" data-toggle="tooltip" data-placement="top" title="" data-original-title="Priyanka"></li>
                                                <li><img src="<?php echo admin_images_url();?>users/4.jpg" alt="user" data-toggle="tooltip" data-placement="top" title="" data-original-title="Selina"></li>
                                            </ul>
                                        </li>
                                        <li class="list-group-item" data-role="task">
                                            <div class="custom-control custom-checkbox">
                                ...
                                <div class="message-box">
                                    <div class="message-widget message-scroll">
                                        ...
                                        <a href="javascript:void(0)">
                                            <div class="user-img"> <img src="<?php echo admin_images_url();?>users/1.jpg" alt="user" class="img-circle"> <span class="profile-status online pull-right"></span> </div>
                                        ...
                                        <!-- Message -->
                                        <a href="javascript:void(0)">
                                            <div class="user-img"> <img src="<?php echo admin_images_url();?>users/2.jpg" alt="user" class="img-circle"> <span class="profile-status busy pull-right"></span> </div>
                                            <div class="mail-contnet">
                                        ...
                                        <!-- Message -->
                                        <a href="javascript:void(0)">
                                            <div class="user-img"> <img src="<?php echo admin_images_url();?>users/4.jpg" alt="user" class="img-circle"> <span class="profile-status offline pull-right"></span> </div>
                                            <div class="mail-contnet">
                            ...
                            <div class="card-body">
                                ...
                                <div class="chat-box">
                                    ...
                                    <ul class="chat-list">
                                        <!--chat Row -->
                                        <li>
                                            <div class="chat-img"><img src="<?php echo admin_images_url();?>users/1.jpg" alt="user"></div>
                                        ...
                                        <!--chat Row -->
                                        <li>
                                            <div class="chat-img"><img src="<?php echo admin_images_url();?>users/2.jpg" alt="user"></div>
                                            <div class="chat-content">
                                                <h5>Bianca Doe</h5>
                                        ...
                                        <!--chat Row -->
                                        <li>
                                            <div class="chat-img"><img src="<?php echo admin_images_url();?>users/3.jpg" alt="user"></div>
                                            <div class="chat-content">
                    ...
                    <div class="slimscrollright">
                        ...
                        <div class="r-panel-body">
                            ...
                            <ul class="m-t-20 chatonline">
                                ...
                                <li>
                                    <a href="javascript:void(0)"><img src="<?php echo admin_images_url();?>users/1.jpg" alt="user-img" class="img-circle"> <span>Varun Dhavan <small class="text-success">online</small></span></a>
                                </li>
                                <li>
                                    <a href="javascript:void(0)"><img src="<?php echo admin_images_url();?>users/2.jpg" alt="user-img" class="img-circle"> <span>Genelia Deshmukh <small class="text-warning">Away</small></span></a>
                                </li>
                                <li>
                                    <a href="javascript:void(0)"><img src="<?php echo admin_images_url();?>users/3.jpg" alt="user-img" class="img-circle"> <span>Ritesh Deshmukh <small class="text-danger">Busy</small></span></a>
                                </li>
                                <li>
                                    <a href="javascript:void(0)"><img src="<?php echo admin_images_url();?>users/4.jpg" alt="user-img" class="img-circle"> <span>Arijit Sinh <small class="text-muted">Offline</small></span></a>
                                </li>
                                <li>
                                    <a href="javascript:void(0)"><img src="<?php echo admin_images_url();?>users/5.jpg" alt="user-img" class="img-circle"> <span>Govinda Star <small class="text-success">online</small></span></a>
                                </li>
                                <li>
                                    <a href="javascript:void(0)"><img src="<?php echo admin_images_url();?>users/6.jpg" alt="user-img" class="img-circle"> <span>John Abraham<small class="text-success">online</small></span></a>
                                </li>
                                <li>
                                    <a href="javascript:void(0)"><img src="<?php echo admin_images_url();?>users/7.jpg" alt="user-img" class="img-circle"> <span>Hritik Roshan<small class="text-success">online</small></span></a>
                                </li>
                                <li>
                                    <a href="javascript:void(0)"><img src="<?php echo admin_images_url();?>users/8.jpg" alt="user-img" class="img-circle"> <span>Pwandeep rajan <small class="text-success">online</small></span></a>
                                </li>
                            </ul>
                        </div>
                    </div>
